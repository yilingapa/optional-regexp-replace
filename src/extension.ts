...
import { Utils, FileHandler } from './utils'
import { defaultHighlightColor, getColorStr } from '../views/const'
        ...
        currentPanel.webview.onDidReceiveMessage(message => {
          if (currentPanel !== undefined) {
            switch (message.command) {
              ...
              case 'editSelected':
                {
                  currentFile?.editSelected(message.payload.match, message.payload.to)
                }
                break
            }
          }
